...
### 🔗 **[CarbonCred](https://github.com/shubham-verma/carboncred)**  
*Blockchain-based Carbon Credit Trading Platform*  
`Solidity` `Hardhat` `React` `TypeScript` `MongoDB`  
Revolutionizing carbon credit transparency with immutable blockchain records.

### 🌐 **[Second Serve](https://github.com/shubham-verma/second-serve)**  
*Social Platform for Tennis Enthusiasts*  
`React` `Node.js` `Express` `MongoDB` `Tailwind`  
Connecting players, coaches, and tournaments in one ecosystem.

### ⚡ **[EVM Wallet Tracker](https://github.com/shubham-verma/evm-wallet-tracker)**  
*Real-time Multi-chain Wallet Analytics*  
`TypeScript` `Ethers.js` `Polygon` `React`  
Track transactions and balances across EVM-compatible chains.

### 🎯 **[DSA Mastery - Java](https://github.com/shubham-verma/dsa-java)**  
*Competitive Programming Solutions*  
`Java` `Algorithms` `Data Structures`  
450+ solved problems with optimized solutions and explanations.

### 🏗️ **[Full-Stack Auth Template](https://github.com/shubham-verma/auth-template)**  
*Production-Ready Authentication System*  
`React` `Node.js` `JWT` `MongoDB`  
Complete auth flow with role-based access and email verification.
...
![Shubham's GitHub Stats](https://github-readme-stats.vercel.app/api?username=shubham-verma&show_icons=true&theme=radical&count_private=true&hide_border=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=shubham-verma&layout=compact&theme=radical&hide_border=true&langs_count=6)

![GitHub Streak](https://streak-stats.demolab.com?user=shubham-verma&theme=radical&hide_border=true&date_format=j%20M%5B%20Y%5D)
